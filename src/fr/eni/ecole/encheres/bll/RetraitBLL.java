...
public class RetraitBLL implements BLL<Retrait>{
	...
	* @author ${Dylan Gilly}
	*
	* Renvoie le retrait contenant la chaine entr�e.
	*/
	@Override
	...
	* @author ${Dylan Gilly}
	*
	* Renvoie la liste des retraits ayant les identifiants entr�s
	* en param�tre.
	*/
	@Override
	...
	* adresses et villes la chaine entr�e en param�tre.
	*/
	@Override
	...
	public void delete(Retrait retrait) throws DALException, BLLException {
		...
		for(Article article : articles) {
			if(retrait.getIdRetrait() == article.getRetrait().getIdRetrait()) {
				throw new BLLException(4000,"Impossible de supprimer un retrait utilisé par un article");
			}
		}
